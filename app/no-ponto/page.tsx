    ...
    return (
        <>
            ...
            <HelpModal
                ...
                tips={[
                    "O GPS é capturado automáticamente ao abrir a página. Se o browser pedir permissão, aceite.",
                    "Os 3 pontos mais próximos aparecem automaticamente. O mais próximo já vem selecionado.",
                    "Não achou o ponto? O ponto pode não estar no banco ainda. Clique em 'Sugerir Ponto'.",
                ]}
            />
        </>
    );
