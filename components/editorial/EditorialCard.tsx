        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden group">
            <div className="p-6 border-b border-gray-50 dark:border-gray-700/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    <div className="bg-brand p-2 rounded-xl text-black shadow-lg shadow-zinc-200 dark:shadow-none">
                        <Sparkles size={18} />
                    </div>
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-2 px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${active
                                    ? 'bg-white dark:bg-zinc-800 text-brand shadow-sm shadow-zinc-200 dark:shadow-none translate-y-[-1px]'
            ...
            <div className="p-6 bg-gray-50/50 dark:bg-gray-800/20">
                <div className="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-inner text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap leading-relaxed relative min-h-[120px]">
                    {strings.caption}
                    <div className="mt-4 pt-4 border-t border-dashed border-gray-100 dark:border-gray-800 text-brand dark:text-brand font-bold uppercase tracking-tight">
                        {strings.cta}
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 bg-brand hover:brightness-110 text-black font-bold py-3 px-4 rounded-xl shadow-lg transition-all active:scale-95 text-xs uppercase tracking-tight"
                    >
            ...
            <div className="px-6 py-3 bg-brand/10 text-[10px] uppercase font-bold text-brand flex items-center gap-2 tracking-widest">
