...
export const PublicTopBar = ({ title, backHref, actions }: PublicTopBarProps) => {
            ...
            <header className="sticky top-0 z-50 glass border-b border-white/5 px-4 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <IconButton
                        ...
                        aria-label="Como funciona em 10s"
                    ...
                    <IconButton
                        ...
                        className="!p-2 hover:bg-white/5 text-muted hover:text-white transition-colors"
                    />
                </div>
            </header>
